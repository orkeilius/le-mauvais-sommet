...
const SettingsScreen = () => {
  ...
  const handleChangePassword = () => {
    ...
    Alert.alert("Mot de passe modifié", "Votre mot de passe a été modifié avec succès")
    setCurrentPassword("")
    setNewPassword("")
    setConfirmPassword("")
  }
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={handleSaveProfile}>
            <View style={styles.actionInfo}>
              ...
              <Text style={[styles.actionText, { color: "#3498db" }]}>Enregistrer les modifications</Text>
            </View>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={handleLogout}>
            <View style={styles.actionInfo}>
              ...
              <Text style={[styles.actionText, { color: "#e74c3c" }]}>Déconnexion</Text>
            </View>
            <Feather name="chevron-right" size={20} color="#ccc" />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={handleDeleteAccount}>
            <View style={styles.actionInfo}>
              ...
              <Text style={[styles.actionText, { color: "#e74c3c" }]}>Supprimer mon compte</Text>
            </View>
            <Feather name="chevron-right" size={20} color="#ccc" />
          </TouchableOpacity>
        </View>
