...
const AddProductScreen = () => {
  ...
  const handleCameraCapture = async () => {
    ...
    if (permissionResult.granted === false) {
      Alert.alert("Permission requise", "Vous devez autoriser l'accès à votre caméra.")
      return
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Exemple: const response = await api.createProduct({...form, category: selectedCategory});

      // Pour la démo, on simule une création réussie
      setTimeout(() => {
        setLoading(false)
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TouchableOpacity style={styles.inputContainer} onPress={toggleCategoryPicker}>
                <Text style={selectedCategory ? styles.input : styles.placeholderInput}>
            ...
            <TouchableOpacity style={styles.submitButton} onPress={handleSubmit} disabled={loading}>
              {loading ? (
                ...
                <Text style={styles.submitButtonText}>
                  {form.isDraft ? "Enregistrer le brouillon" : "Créer le produit"}
                </Text>
              )}
            </TouchableOpacity>
          </View>
